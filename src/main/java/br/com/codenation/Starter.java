...
public class Starter {
    ...
    public static void main(String[] args) {
        ...
        desafio.incluirTime(1L, "Nome", LocalDate.of(1914, 8, 25), "verde", "branco");
        desafio.incluirTime(2L, "Nome", LocalDate.of(1914, 8, 25), "laranja", "branco");
        desafio.incluirJogador(1L, 1L, "Jogador 1", LocalDate.of(1995, 9, 20), 8, BigDecimal.valueOf(15000));
        desafio.incluirJogador(2L, 1L, "Jogador 2", LocalDate.of(1998, 12, 23), 10, BigDecimal.valueOf(20000));
